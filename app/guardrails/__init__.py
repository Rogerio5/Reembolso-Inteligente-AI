...
def resposta_fora_escopo(
    ...
    opcoes = (
        (
            "Só posso tratar informações da carteirinha "
            "que abriu esta sessão. Pedidos referentes "
            "a outra pessoa estão fora do escopo deste "
            "atendimento."
        ),
        (
            "Este atendimento está vinculado ao "
            "beneficiário que iniciou a sessão. Não "
            "posso consultar ou analisar pedido de "
            "outra pessoa por aqui."
        ),
        (
            "Por segurança, não posso responder sobre "
            "beneficiário diferente daquele vinculado "
            "a esta sessão. Esse pedido fica fora do "
